...
int main() {
    ...
    // getting inputfilename
    string inputfilename;
    bool wrappedAround; // whether the game should be played by wrapped around rule or not.
    ...
    while (alive(curt_grid)) {
        string action = getLine("a)nimate, t)ick, q)uit?"); // further prompt for next movement
